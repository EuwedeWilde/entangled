...
function findWasmBinary() {
  return locateFile("graph64.wasm");
}
...
function assignWasmExports(wasmExports) {
  _performLayout = Module["_performLayout"] = wasmExports["l"];
...
function applySignatureConversions(wasmExports) {
  ...
  wasmExports["m"] = makeWrapper_pp(wasmExports["m"]);
  wasmExports["p"] = makeWrapper_pp(wasmExports["p"]);
